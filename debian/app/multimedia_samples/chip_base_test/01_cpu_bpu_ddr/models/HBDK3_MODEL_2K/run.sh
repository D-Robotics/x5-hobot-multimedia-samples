...
HBM_FILE=$MODELS_DIR/HBDK3_MODEL_2K/x5/gen_I2004_ForTest2k_1x1088x2048x3.hbm

OUTPUT_0_0=/userdata/model-2k_00/
OUTPUT_0_1=/userdata/model-2k_01/
OUTPUT_1_0=/userdata/model-2k_10/
OUTPUT_1_1=/userdata/model-2k_11/
SRC_FILE=$MODELS_DIR/HBDK3_MODEL_2K/input_0_feature_1x1088x2048x3_ddr_native.bin
