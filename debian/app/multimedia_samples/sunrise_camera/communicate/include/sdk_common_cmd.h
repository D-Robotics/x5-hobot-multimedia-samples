...
typedef enum
{
	...
	SDK_CMD_VPP_CHECK_SOLUTION_CONFIG,
	...
	SDK_CMD_MEDIA_SERVER_INIT,
	SDK_CMD_MEDIA_SERVER_CREATE,
	SDK_CMD_MEDIA_SERVER_PUSH_DATA,
	SDK_CMD_MEDIA_SERVER_DESTROY,
	SDK_CMD_MEDIA_SERVER_UNINIT,
